...
export class AuthenticationService {
  ...
  public async requestToken() {
    ...
    await this.httpClient.post("https://synapseidentityserver-test.interneuron.io/connect/token", "grant_type=password&client_id=ropwd&username=indiwar@interneuron.org&password=password_123&scope=dynamicapi.read",
      { headers: headers })
