...
export class DynamicApiRequestService {
  ...
  public getRequest(uri: string): Observable<any> {
    ...
    return from(this.appService.dynamicApiServiceRef.getRequest(uri));
  ...
  public postRequest(uri: string, body: any): Observable<any> {
    ...
    return from(this.appService.dynamicApiServiceRef.postRequest(uri, body));
  ...
  public deleteRequest(uri: string): Observable<any> {
    ...
    return from(this.appService.dynamicApiServiceRef.deleteRequest(uri));
  ...
  public getDocumentByPost(uri: string, body: any): Observable<any> {
    ...
    return from(this.appService.dynamicApiServiceRef.getDocumentByPost(uri, body));
  }
